...
- Play with `jq`:
  ...
  - [`jiq`](https://github.com/bellicose100xp/jiq) is TUI for writing jq
    queries with live results while you type in the TUI: Interactive JSON query
    tool with real-time output and AI assistance.
    <sup><sup>[+](https://terminaltrove.com/jiq)</sup></sup>
    <sup><sup>[+](https://github.com/bellicose100xp/jiq)</sup></sup>
